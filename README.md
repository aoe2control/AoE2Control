...
\[cite\_start]CONTROL is a powerful Lua scripting engine that communicates directly with Age of Empires II: Definitive Edition\[cite: 5]. \[cite\_start]It allows you to read the internal game state and send commands directly without relying on pixel scanning or mouse/keyboard simulation\[cite: 6]. 



\[cite\_start]Whether you are building complex custom AI, automating specific game mechanics, or training external machine learning agents via IPC named pipes\[cite: 71, 72], CONTROL provides a comprehensive API to make it happen.



\[cite\_start]\*\*⚠️ Important:\*\* To protect the integrity of the game's ranking system, this engine is strictly restricted to single-player use\[cite: 7]. \[cite\_start]Multiplayer functionality is completely disabled\[cite: 92].
...
\*\*\[Join the Discord Server](YOUR\_DISCORD\_INVITE\_LINK)\*\*



\## 🛡️ Installation \& Antivirus Notice
